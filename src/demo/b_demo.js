...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lightbox = __webpack_require__(302);

	var _lightbox2 = _interopRequireDefault(_lightbox);

	var _tab = __webpack_require__(303);

	var _assemblage = __webpack_require__(304);
	...
	var _aside = __webpack_require__(306);
	...
	var _labels = __webpack_require__(310);
	        ...
	        value: function render() {
	            ...
	            var TabNodes = [],
	                ...
	                action: function action() {
	                    return location.href = 'mailto:feedback@trendiguru.com';
	                }
	            }, {
	                icon: 'close',
	                ...
	                return React.createElement(
	                    'button',
	                    { key: i, id: button.icon, onClick: button.action },
	                    React.createElement(
	                        'i',
	                        { className: 'md-icon' },
	                        button.icon
	            ...
	            if (data === undefined) {
	                TabNodes = React.createElement(_loading2.default, null);
	            } else if (data === null) {
	                TabNodes = React.createElement(
	                    'div',
	                    null,
	                    'No data found for this image'
	                );
	            } else if (data.lables) {
	                TabNodes = React.createElement(_labels2.default, { labels: this.props.labels });
	            } else if (data.items) {
	                TabNodes = this.props.data.items.map(function (item, i) {
	                    return React.createElement(
	                        _tab.Tab,
	                        { key: i, title: item.category },
	                        React.createElement(_assemblage2.default, {
	                            col: 5,
	                            minWidth: 180,
	                            margin: 8,
	                            marginBottom: 70,
	                            template: function template(img) {
	                                return React.createElement(_card2.default, { link: img.link, image: img.src, labels: { price: img.price.price, brand: img.brand } });
	                            },
	                            src: item.similar_results.map(function (result) {
	            ...
	            return React.createElement(
	                _lightbox2.default,
	                { ref: 'app' },
	                React.createElement(_aside2.default, { imageURL: this.props.imageURL }),
	                React.createElement(
	                    _tab.TabView,
	                    {
...
/***/ function(module, exports) {
	...
	var Lightbox = function (_React$Component) {
	    ...
	    function Lightbox(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Lightbox).call(this, props));
	    }
...
/***/ function(module, exports) {
	...
	var TabView = exports.TabView = function (_React$Component) {
	    _inherits(TabView, _React$Component);

	    function TabView(props) {
	        _classCallCheck(this, TabView);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TabView).call(this, props));
	    ...
	    _createClass(TabView, [{
	        ...
	        value: function setTab(i) {
	            this.setState({ tab: i });
	            var e = Object.assign(new Event('tab set', { bubbles: true }), {
	                info: {
	        ...
	        value: function render() {
	            ...
	            children.forEach(function (tab, i) {
	                TitleNodes.push(React.createElement(
	                    'li',
	                    { key: i, onClick: _this2.setTab.bind(_this2, i), className: _this2.state.tab == i ? 'select' : '' },
	                    tab.props.title
	                ));
	                TabNodes.push(React.cloneElement(tab, { key: i, index: i, select: _this2.state.tab }));
	            });
	            var liWidth = 100 / children.length || 0;
	            return React.createElement(
	                'div',
	                { ref: 'root' },
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        null,
	                        TitleNodes,
	                        React.createElement('label', { className: 'indicator', style: { left: this.state.tab * liWidth + '%', width: liWidth + '%' } })
	                    ),
	                    React.createElement(
	                        'aside',
	                        null,
	...
	var Tab = exports.Tab = function (_React$Component2) {
	    ...
	    _createClass(Tab, [{
	        ...
	        value: function render() {
	            return React.createElement(
	                'section',
	                { style: { width: '100%', left: (this.props.index - this.props.select) * 100 + '%', top: 0, position: 'absolute' } },
	                this.props.children
	            );
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	var Assemblage = function (_React$Component) {
	    _inherits(Assemblage, _React$Component);

	    function Assemblage(props) {
	        _classCallCheck(this, Assemblage);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Assemblage).call(this, props));

	        _this.state = {
	            src: [],
	            done: Array(_this.props.src.length).fill(false)
	        };
	        return _this;
	    }
	    ...
	    _createClass(Assemblage, [{
	        key: 'loadImage',
	        value: function loadImage(origin, i) {
	            var _this2 = this;

	            return new Promise(function (resolve, reject) {
	                var img = Object.assign(new Image(), origin);
	                img.onload = function () {
	        ...
	        value: function componentDidMount() {
	            ...
	            this.loadImages(this.props.src).then(function () {
	                var done = new Event('done', { bubbles: true });
	                done.info = { loaded: _this3.state.done };
	                dispatchEvent(done);
	            });
	        ...
	        value: function render() {
	            var ImageNodes = [];
	            try {
	                var clientWidth = this.refs.root.clientWidth;
	                var col = Math.floor(clientWidth / this.props.minWidth);
	                var width = clientWidth / col;
	                var src = this.state.src;
	                var margin = this.props.margin;
	                var marginBottom = this.props.marginBottom || margin;
	                var indexed = Array(Math.ceil(src.length / col)).fill(0).map(function () {
	                    return [];
	                });
	                for (var i = 0; i < src.length; i++) {
	                    var img = this.state.src[i],
	                        row = (i - i % col) / col,
	                        index = i % col;
	                    Object.assign(img, {
	                    ...
	                    ImageNodes[i] = React.createElement(
	                        'div',
	                        {
	                            key: i,
	                            style: {
	...
	var Card = function (_React$Component) {
	    ...
	    _createClass(Card, [{
	        ...
	        value: function click() {
	            var event = new Event('result clicked', { bubbles: true });
	            event.data = {
	        ...
	        value: function render() {
	            ...
	            var LabelNodes = Object.keys(labels).map(function (label) {
	                return React.createElement(
	                    "span",
	                    { className: label },
	                    labels[label]
	            ...
	            return React.createElement(
	                "a",
	                { ref: "card", href: this.props.link, onClick: this.click.bind(this), target: "_blank" },
	...
	var Aside = function (_React$Component) {
	    ...
	    _createClass(Aside, [{
	        ...
	        value: function load(props) {
	            ...
	            img.onload = function () {
	                return _this2.setState({ img: img });
	            };
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            return React.createElement("aside", { ref: "root", style: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loading = function (_React$Component) {
	    ...
	    _createClass(Loading, [{
	        ...
	        key: "setGiphy",
	        value: function setGiphy() {
	            this.setState({ giphy: _constants.LOADING_GIPHIES[getRandomInt(0, _constants.LOADING_GIPHIES.length - 1)] });
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            return React.createElement(
	                "div",
	                { className: "loading" },
	                React.createElement("div", { className: "giphy", onClick: this.setGiphy.bind(this), style: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.TUTOIRAL_VERSION = exports.LOADING_GIPHIES = exports.API_URL = exports.COOKIE_NAME = exports.SERVER_URL = exports.ENV = exports.PID = exports.USER_CONFIG = exports.LIBNAME = exports.INFO_URL = exports.IFRAME_ID = exports.CSS_URL = exports.IFRAME_SRC = exports.GA_CODE = exports.MIXPANEL_ID = exports.DEBUG = exports.MIN_IMG_HEIGHT = exports.MIN_IMG_WIDTH = exports.HOST_DOMAIN = undefined;
	exports.UISettings = UISettings;

	var _utils = __webpack_require__(309);

	var scriptTagData = loadScriptTagData();

	//export const HOST_DOMAIN = 'https://fzz.storage.googleapis.com',
	var HOST_DOMAIN = exports.HOST_DOMAIN = 'https://localhost:4443',
	    ...
	    IFRAME_SRC = exports.IFRAME_SRC = HOST_DOMAIN + '/app/index.html',
	    CSS_URL = exports.CSS_URL = HOST_DOMAIN + '/plugin/css/b_plugin.css',
	    IFRAME_ID = exports.IFRAME_ID = 'fazzi',
	    INFO_URL = exports.INFO_URL = 'http://fazz.co',
	    LIBNAME = exports.LIBNAME = 'fzz',
	    USER_CONFIG = exports.USER_CONFIG = scriptTagData.userConfig,
	    PID = exports.PID = _utils.Query.parse(location.search).PID || scriptTagData.pid || '_PD',
	    ENV = exports.ENV = ['PRODUCTION', 'DEV'][0],
	    ...
	    LOADING_GIPHIES = exports.LOADING_GIPHIES = ['UPAJRWATdepFK', 'PLw7s7Ezb50OY', '13SHVEhqEPfSXC', 'hLBNOS9GOBCH6', '7DNcclBIsgUzC', '5AtHzs3lLbbWg', 'VLHmZU5YQidm8'],
...
/***/ function(module, exports) {
	...
	var getStyle = exports.getStyle = window.getComputedStyle || function (elem) {
	...
	*/
	...
	function selectorMatches(el, selector) {
	    if (!(el instanceof Element)) return function () {
	        return false;
	    };
	...
	function dictMerge(dict1, dict2) {
	    ...
	    if (dict1) {
	        ...
	        try {
	            for (var _iterator3 = entries(dict1)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                var _step3$value = _slicedToArray(_step3.value, 2);

	                var key = _step3$value[0];
	                var obj = _step3$value[1];
	    ...
	    if (dict2) {
	        ...
	        try {
	            for (var _iterator4 = entries(dict2)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	                var _step4$value = _slicedToArray(_step4.value, 2);

	                var key = _step4$value[0];
	                var obj = _step4$value[1];
	...
	var Query = exports.Query = function () {
	    ...
	    _createClass(Query, null, [{
	        ...
	        value: function stringify(query) {
	            ...
	            try {
	                for (var _iterator5 = entries(query)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _giphy = __webpack_require__(311);
	...
	var Labels = function (_React$Component) {
	    ...
	    _createClass(Labels, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            Promise.all(Object.keys(labels).map(function (label) {
	                return (0, _giphy2.default)(label);
	            })).then(function (responses) {
	                return _this2.setState({
	                    labels: responses.map(function (response) {
	                        return {
	        ...
	        key: "render",
	        value: function render() {
	            var LabelNodes = this.state.labels.map(function (label, i) {
	                return React.createElement(
	                    "div",
	                    { className: "label", key: i },
	                    React.createElement("div", { className: "img", style: { backgroundImage: "url(" + label.giphy.data[0].images.original.url + ")" } }),
	                    React.createElement(
	                        "div",
	                        { className: "tag" },
	                        React.createElement(
	                        ...
	                        React.createElement(
	                            "div",
	                            { className: "graph" },
	                            React.createElement("div", { className: "bar", style: { width: label.percentage * 100 + '%' } })
	                        )
	                    )
	                );
	            });
...
/***/ function(module, exports) {
	...
	function giphy(query) {
	    return fetch("http://api.giphy.com/v1/gifs/search?api_key=dc6zaTOxFJmzC&q=" + query).then(function (res) {
	        return res.json();
	    }).then(function (res) {
	        res.query = query;
	        return res;
...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(_demo2.default), document.getElementById('root')); /* globals React, ReactDOM */
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* globals React */

	var _React = React;
	var Component = _React.Component;


	var API_URLS = ['https://extremeli.trendi.guru/api/images', 'https://api.fazz.co/images'];
	    ...
	    _createClass(Demo, [{
	        ...
	        value: function close() {
	            this.setState(function (state) {
	                state.component = _discover2.default;
	        ...
	        value: function search(url) {
	            ...
	            Promise.race([sources.get, sources.post]).then(function (res) {
	                return new Promise(function (resolve, reject) {
	                    if (res.relevancy_dict) {
	                        ...
	                        if (res !== null) {
	                            ...
	                            // try posting it and check agian
	                            sources.post.then(function (res) {
	                                if (res.relevancy_dict[url]) {
	                                    _this2.state.api.get(url).then(resolve);
	                                } else {
	                                    reject();
	                                }
	                            });
	                ...
	                _this2.setState(function (state) {
	                    return Object.assign(state.components.App, { data: data });
	                });
	            }).catch(function () {
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                'div',
	                null,
	                React.createElement('img', { id: 'logo', className: Object.keys(components.App).length ? 'min' : '', src: '/src/demo/img/logo.svg' }),
	                ...
	                React.createElement(
	                    ...
	                    React.createElement('label', {
	                        className: (0, _classnames2.default)('switch', {
	                            checked: this.state.api_index
	                        }),
	                        onClick: function onClick() {
	                            return _this3.setState({
	                                api_index: !_this3.state.api_index,
	                                api: new _api2.default(API_URLS[Number(!_this3.state.api_index)])
	                            });
	                        },
	                        style: {
	                            margin: '0 1em'
...
/***/ function(module, exports) {
	...
	var API = function () {
	    function API(api_url) {
	        ...
	        Object.assign(this, { api_url: api_url });
	    }

	    _createClass(API, [{
	        key: 'get',
	        value: function get(image_url) {
	            return fetch(this.api_url + '?imageUrl=' + image_url).then(function (res) {
	                return res.json();
	            });
	        }
	    }, {
	        key: 'post',
	        value: function post(image_urls) {
...
/***/ function(module, exports) {
	...
	var Discover = function (_Component) {
	    ...
	    function Discover(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Discover).call(this, props));
	    ...
	    _createClass(Discover, [{
	        ...
	        value: function render() {
	            ...
	            var ImageNodes = this.props.images.map(function (src, i) {
	                return React.createElement("img", { key: i, onClick: function onClick() {
	                        return _this2.props.search(src);
	                    }, src: src });
	            });
	            return React.createElement(
	                "div",
	...
	var Searchbox = function (_Component) {
	    ...
	    _createClass(Searchbox, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                "div",
	                { id: "searchbox", className: this.props.className },
	                React.createElement("input", { ref: "searchbox", type: "text", placeholder: "Image URL" }),
	                React.createElement(
	                    "button",
	                    { onClick: function onClick() {
	                            return _this2.props.search(_this2.refs.searchbox.value);
	                        } },
	                    "search"
	                )
	            );
